...
>
  {item.year}
        ...
        <div className="flex items-center justify-between mt-12">
          ...
          <button className="prev-btn w-11 h-11 rounded-full border border-gray-300 flex items-center justify-center text-[#0a3e40] hover:bg-[#b8965a] hover:text-white transition">
            <i className="fa-solid fa-arrow-left"></i>
          </button>

          <div className="custom-dots flex justify-center items-center gap-2"></div>

          <button className="next-btn w-11 h-11 rounded-full bg-[#b8965a] text-white flex items-center justify-center hover:opacity-80 transition">

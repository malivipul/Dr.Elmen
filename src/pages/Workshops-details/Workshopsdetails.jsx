        ...
        <div className="bg-[#e7dfd7] rounded-[22px] p-5 overflow-hidden relative border border-[#ece6dc]">
          ...
          <div className="space-y-3 relative z-10">
            ...
            {[
              ...
              <div
                key={index}
                className="group bg-white hover:bg-[#111111] border border-[#ece6dc] hover:border-[#111111] rounded-[16px] px-4 py-3 transition-all duration-500"
              >

                <div className="flex items-center justify-between gap-3">

                  {/* TEXT */}
                  <p className="text-[14px] md:text-[15px] text-[#111111] group-hover:text-white leading-[26px] transition-all duration-500">
                    {service}
                  </p>

                  {/* ARROW */}
                  <span className="text-[18px] text-[#b8965a] transition-all duration-500 group-hover:translate-x-1">
                    →
                  </span>

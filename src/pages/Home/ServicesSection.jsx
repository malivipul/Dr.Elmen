const ServicesSection = () => {
  ...
  return (
    <section className="bg-[#f5f3ef] py-[80px]">
          ...
          >
            ...
            <div className="p-7">
              ...
              <div className="mt-5">
                <a
                  href="#"
                  className="inline-block px-5 py-2 rounded-full bg-[#b8965a] text-white text-sm border border-[#b8965a] hover:bg-transparent hover:text-[#b8965a] transition"
                >
                  Learn more →
                </a>
              </div>
